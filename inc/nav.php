		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-5 logo">
					<a href="http://localhost/index.php"><img src="img/logo.webp" class="img-responsive" alt=""/></a>
				</div>
			...
			<div class="menu-wrap">
				...
				<ul class="sf-menu">
					...
					<li>
						<a href="http://localhost/index.php">Shop</a>
					...
					<li>
						<a href="http://localhost/my-account.php">My Account</a>
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="http://localhost/my-account.php">My Orders</a></li>
							<li><a href="http://localhost/wishlist.php">My Wishlist</a></li>
							<li><a href="http://localhost/edit-address.php">Update Address</a></li>
